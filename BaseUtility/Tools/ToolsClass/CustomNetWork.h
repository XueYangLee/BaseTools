...
typedef void( ^ LXYResponseSuccess)(id response);
typedef void( ^ LXYResponseFail)(NSError *error);

typedef void( ^ LXYUploadProgress)(int64_t bytesProgress,
int64_t totalBytesProgress);

typedef void( ^ LXYDownloadProgress)(int64_t bytesProgress,
int64_t totalBytesProgress);
 ...
 *  - (void)resume，继续任务
 */
typedef NSURLSessionTask LXYURLSessionTask;
